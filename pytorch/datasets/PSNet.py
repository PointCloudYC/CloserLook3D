...
class PSNetSeg(data.Dataset):
    def __init__(self, input_features_dim, subsampling_parameter,
        ...
        """PSNet dataset for scene segmentation task.
        ...
        self.folder = 'PSNet'
        self.data_dir = os.path.join(self.data_root, self.folder, 'PSNet_reduced_5', 'processed')
        ...
        if not os.path.exists(filename):
            ...
            for cloud_idx, cloud_name in enumerate(self.cloud_names):
                ...
                if os.path.exists(cloud_file):
                    ...
                    cloud_folder = os.path.join(self.data_root, self.folder, 'PSNet_reduced_5', cloud_name)
...
if __name__ == "__main__":
    ...
    dset = PSNetSeg(4, in_radius=2.0, subsampling_parameter=0.04, num_points=15000,
                    num_steps=2000, num_epochs=600, split='train', transforms=transforms)
    dset_v = PSNetSeg(4, in_radius=2.0, subsampling_parameter=0.04, num_points=15000,
